        ...
        <div className="space-y-1 min-w-0 flex-1">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {team.isSpecialCategory && (
              <span className="px-1.5 py-0.5 rounded bg-[#E83C00]/10 border border-[#E83C00]/20 text-[9px] font-black text-[#E83C00] uppercase tracking-wider shrink-0">
                Special Category
              </span>
            )}
            {team.round ? (
                ...
                {isEvaluating ? (
                  ...
                  <div className="flex flex-col flex-1 min-h-0">
                    ...
                    {activeTeam.isSpecialCategory && (
                      <div className="mx-3.5 mt-2.5 px-3 py-2.5 rounded-xl bg-[#E83C00]/10 border border-[#E83C00]/25 shadow-xs">
                  ...
                  <div className="flex flex-col flex-1 min-h-0">
                    <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-6">
                      <div className="flex justify-between items-start">
                        <div className="flex items-center gap-2 flex-wrap">
                          {activeTeam.isSpecialCategory && (
                            <span className="text-[10px] font-black px-2.5 py-1 rounded-full border bg-[#E83C00]/10 text-[#E83C00] border-[#E83C00]/20 uppercase tracking-widest">
                              Special Category
                            </span>
                          )}
                          <span
                      ...
                      {activeTeam.isSpecialCategory && (
                        <div className="rounded-xl border border-[#E83C00]/25 bg-[#E83C00]/10 px-3.5 py-3">
                          <p className="text-[11px] font-black text-[#1A1A1A] uppercase tracking-wider">
